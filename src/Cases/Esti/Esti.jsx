    ...
    return (
        <div className={classes.page}>
            <div className={classes.inner}>
                ...
                <div className={classes.text2} style={{textAlign: "center"}}>The perfect content creator toolkit: an app
                ...
                <div style={{marginBottom: 32}}/>
                <div className={classes.text2}>After conducting research, I decided to try sketching a few simple drafts
                ...
                <div className={classes.columns}>
                    ...
                    <div className={classes.item}>
                        <div className={classes.box}>
                            <div className={classes.text2}>
                                To ensure higher quality results from the interviews, I created prototypes.<br/><br/>
                ...
                <div className={classes.shortlist}>
                    ...
                    <div className={classes.text2}>Do you understand when the photo was posted to the Instagram?</div>
                </div>
                <div style={{marginBottom: 64}}/>
                ...
                <div style={{marginBottom: 16}}/>
                <div className={classes.text5}>Based on this chart, around 80% of users are interested in the planner.
                </div>
                <div style={{marginBottom: 42}}/>
                <div style={{textAlign: "center"}}><img src={chart2} alt="chart2"/></div>
                <div style={{marginBottom: 16}}/>
                <div className={classes.text5}>Roughly half of the users struggle to understand the current UX of the
                    planner.
                </div>
                <div style={{marginBottom: 64}}/>
                ...
                <div className={classes.points}>
                    ...
                    <div className={classes.text2}>2. Refine the content on the onboarding screens, as we noticed issues
